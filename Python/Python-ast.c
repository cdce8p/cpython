...
ast2obj_stmt(struct ast_state *state, struct validator *vstate, void* _o)
{
    ...
    case For_kind:
        ...
        if (PyObject_SetAttr(result, state->body, value) == -1)
            goto failed;
        Py_DECREF(value);
        value = ast2obj_list(state, vstate, (asdl_seq*)o->v.For.if_break,
                             ast2obj_stmt);
        if (!value) goto failed;
    ...
    case AsyncFor_kind:
        ...
        if (PyObject_SetAttr(result, state->body, value) == -1)
            goto failed;
        Py_DECREF(value);
        value = ast2obj_list(state, vstate, (asdl_seq*)o->v.AsyncFor.if_break,
                             ast2obj_stmt);
        if (!value) goto failed;
        if (PyObject_SetAttr(result, state->if_break, value) == -1)
            goto failed;
    ...
    case While_kind:
        ...
        if (PyObject_SetAttr(result, state->body, value) == -1)
            goto failed;
        Py_DECREF(value);
        value = ast2obj_list(state, vstate, (asdl_seq*)o->v.While.if_break,
                             ast2obj_stmt);
        if (!value) goto failed;
        if (PyObject_SetAttr(result, state->if_break, value) == -1)
            goto failed;
